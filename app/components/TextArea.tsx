    ...
    <div className="grid gap-100">
        ...
        <textarea
            ...
            className={classNames(
                "p-200 rounded-6 transition-all border border-neutral-9 bg-neutral-0 text-preset-4--regular w-full h-[100px] resize-none hover:shadow-[2px_2px_0_0_#2E1401] focus:shadow-[2px_2px_0_0_#5072C7] focus:outline-none focus:border-blue-6",
                {
